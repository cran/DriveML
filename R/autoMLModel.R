...
#' }
#' @param models [character | Optional] Which models to train. Default is all. List of strings denoting which algorithms to use for the process:
#' \itemize{
...
#' }
#' @param perMetric [character | Optional] Model validation metric. Default "auc"
#' \itemize{
...
#' @param pdp [logical | Optional] Partial dependence plot for top important variables
...
#' @importFrom SmartEDA ExpCatViz ExpData
...
autoMLmodel <- function(train,  test = NULL,  score = NULL, target = NULL,
                        testSplit = 0.2, tuneIters = 200,  tuneType = "random",  models = "all",
                        perMetric = "auc", varImp = 20,  liftGroup = 50,  maxObs = 10000,  uid = NULL,
